...
- <Tech-stack / architecture constraints this must respect — e.g. "new schema in the feature's schemas/", "must go through a Server Component / route handler, never queried from the client">

## Affected Areas

- [ ] `apps/nextjs` (which feature/route)
...
- [ ] <e.g. "POST /api/widgets returns 400 on an invalid body">
- [ ] <e.g. "GET /api/v1/widgets returns an empty array, not an error, when none exist">
